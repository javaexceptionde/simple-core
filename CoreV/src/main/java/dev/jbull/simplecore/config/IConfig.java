...
public interface IConfig {
     ...
     */
    void load(Callback<IConfig> callback);
     ...
     */
    void save(Callback<IConfig> callback);
     ...
     */
    void get(String key, Callback<Object> callback);
     ...
     * @param callback the callback contains the value of the given key
     */
    void getString(String key, Callback<String> callback);
     ...
     * @param callback the callback contains the value of the given key
     */
    void getInt(String key, Callback<Integer> callback);
     ...
     * @param callback the callback contains the value of the given key
     */
    void getBoolean(String key, Callback<Boolean> callback);
     ...
     * @param callback the callback contains the value of the given key
     */
    void getDouble(String key, Callback<Double> callback);
     ...
     */
    void getKeys(String key, boolean deep, Callback<Set<String>> callback);
     ...
     */
    Set<String> getKeys(String key, boolean deep);
